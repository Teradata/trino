...
public class TestTeradataTypeMapping
        extends AbstractTeradataJDBCTest
{
    public TestTeradataTypeMapping()
    {
        super(ClearScapeEnvironmentUtils.generateUniqueEnvName(TestTeradataTypeMapping.class));
    }
    ...
    public void testNumber()
    {
        SqlDataTypeTest.create()
                ...
                .addRoundTrip("numeric(3)", "null", createDecimalType(3, 0), "CAST(null AS decimal(3, 0))").execute(getQueryRunner(), teradataJDBCCreateAndInsert("number"));
    }
    ...
    public void testChar()
    {
        ...
        // max-size
        SqlDataTypeTest.create().addRoundTrip("char(64000)", "'max'", createCharType(64000), "CAST('max' AS char(64000))")
    ...
    public void testVarchar()
    {
        ...
        // max-size
        SqlDataTypeTest.create()
                .addRoundTrip("long varchar", "'max'", createVarcharType(64000), "CAST('max' AS varchar(64000))").execute(getQueryRunner(), teradataJDBCCreateAndInsert("varcharl"));
    }
    ...
    public void testByte()
    {
        ...
        if (tmode.equals("TERA")) {
            ...
            // Error on truncation
            assertThatThrownBy(() ->
                    SqlDataTypeTest.create().addRoundTrip("byte(3)", "'01234567'XB", VARBINARY, "X'012345'")
                            .execute(getQueryRunner(), teradataJDBCCreateAndInsert("bytet")))
                    .isInstanceOf(RuntimeException.class)
                    .hasCauseInstanceOf(SQLException.class)
                    .cause()
        ...
        // max-size
        SqlDataTypeTest.create().addRoundTrip("byte(64000)", "'FF'XB", VARBINARY, padBinaryString("FF", 64000))
    ...
    public void testTime()
    {
        SqlDataTypeTest.create().addRoundTrip("time", "time '00:00:00'", createTimeType(6), "CAST('00:00:00' AS TIME(6))")
                ...
                .addRoundTrip("time(6)", "time '23:59:59.999999'", createTimeType(6), "CAST('23:59:59.999999' AS TIME(6))").execute(getQueryRunner(), teradataJDBCCreateAndInsert("time"));
    }
