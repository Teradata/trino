...
public final class TeradataQueryRunner
{
            ...
            extends DistributedQueryRunner.Builder<Builder>
    {
        ...
        {
            this.connectorProperties = Map.copyOf(requireNonNullElse(connectorProperties, Map.of()));
            return this;
        }
                ...
                throws Exception
        {
            super.setAdditionalSetup(runner -> {
                ...
                Map<String, String> properties = new HashMap<>(server.getCatalogProperties());
                properties.putAll(connectorProperties);
                runner.installPlugin(new TeradataPlugin());
                runner.createCatalog("teradata", "teradata", properties);
